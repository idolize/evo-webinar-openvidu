...
Cloud Formation stack template designed to be used to spin up the entire stack needed to run this service.

_Originally from https://github.com/OpenVidu/openvidu-cloud-devops_

**NOTE: This script may not be accurate anymore in setting up a EC2 instance exactly right. Refer to root README instructions for how to manually deploy.**
